...
{
    public void InitializePool<T>(ref T[] pool, IMonoBehaviourPool prefab, int amount, RectTransform holder) where T : IMonoBehaviourPool
    {
    ...
    public IMonoBehaviourPool TryGetMonoBehaviourFromPool<T>(ref T[] pool, IMonoBehaviourPool prefab, RectTransform holder) where T : IMonoBehaviourPool
    {
